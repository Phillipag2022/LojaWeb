...
public class PessoaGerenciamentoService {
    ...
    public ResponseEntity<String> solicitarCodigo(@RequestBody String email){
        ...
        propMap.put("mensagem", "O seu codigo para recuperação de senha é o seguinte "+pessoa.getCodigoRecuperaçaoSenha());
        emailService.enviarEmailTemplate(pessoa.getEmail(), "Codigo de recuperação de senha" , propMap);
